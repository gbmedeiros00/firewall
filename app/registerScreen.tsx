...
export default function RegisterScreen({
  ...
  const handleRegister = async () => {
    ...
    try {
      // Conectando diretamente no seu IPv4 da rede local (Wi-Fi):
...
const s = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: Platform.OS === 'android' ? SPACING.md : 54,
    gap: SPACING.sm,
  },
  headerBrand: {
    color: COLORS.white,
  ...
  scroll:   { flex: 1 },
  content:  { paddingHorizontal: SPACING.xxl, paddingTop: SPACING.xxxl, paddingBottom: 48 },
  title: {
    fontSize: 28,
    fontWeight: '700',
    fontFamily: FONTS.headline,
